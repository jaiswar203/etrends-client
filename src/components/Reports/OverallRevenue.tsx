...
import { IReportQueries, IDetailedOverAllSalesReportResponse, useGetDetailedOverAllSalesReportQuery } from "@/redux/api/report"
...
const OverallRevenueChart = () => {
    ...
    const { data, isSuccess, refetch } = useGetDetailedOverAllSalesReportQuery(filters)
    ...
    return <RevenueChart
        data={graphData}
        isLoading={!isSuccess}
        description="Revenue generated from orders, customizations, licenses, additional services, and AMC."
